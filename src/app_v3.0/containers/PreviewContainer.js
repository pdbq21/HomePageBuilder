...
class PreviewContainer extends Component {
    ...
    dataTest(){
        console.log(this.props.mapStateEditPanel, this.props.mapStateWorkArea);


        function getData(data, id, type, nextType) {
            let newData = [];
            data[id].childrenIds.forEach(function (_id) {
                newData.push({
                    [type]: {
                        id: _id,
                        style: this.props.mapStateEditPanel[_id],
                        [nextType]: getData(data[_id], _id, 'rows', 'col')
                    }
                    });
            });
            return newData;
        ...
        getData(this.props.mapStateWorkArea, 'id_work_area', 'sections', 'rows');
    }
